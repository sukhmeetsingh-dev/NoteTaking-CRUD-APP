 ...
 * 
 * @param {Boolean} isThereAnyNotebooks - Indicates whether there are any noteboks. 
 */
...
export const client = {
    ...
    notebook: {
        ...
        update(notebookId, notebookData) {
            const /** {HTMLElements} */ $oldNotebook = document.querySelector(`[data-notebook="${notebookId}"`);
